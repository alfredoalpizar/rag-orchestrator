...
class ChromaDBClientImpl(
    ...
    override fun queryWithEmbedding(
    ...
    override fun delete(ids: List<String>): Mono<Unit> {
    ...
    override fun deleteByMetadata(filter: Map<String, Any>): Mono<Unit> {
    ...
    override fun createCollectionIfNotExists(): Mono<Unit> {
